...
<xsl:for-each select="//document/row">
	<xsl:if test="position() = $selitem">
		<input type="hidden" name="itemclass">
			<xsl:attribute name="value">
				<xsl:value-of select="substring-before(Sub,'-')"/>
			</xsl:attribute>
		</input><input type="hidden" name="subclass">
			<xsl:attribute name="value">
				<xsl:value-of select="substring-after(Sub,'-')"/>
			</xsl:attribute>
		</input><input type="hidden" name="Idesc">
			<xsl:attribute name="value">
				<xsl:value-of select="Itemdesc"/>
			</xsl:attribute>
		</input><input type="hidden" name="Asset">
			<xsl:attribute name="value">
				<xsl:value-of select="Asset_No"/>
			</xsl:attribute>
		</input><input type="hidden" name="DPTMT">
			<xsl:attribute name="value">
				<xsl:value-of select="DPT"/>
			</xsl:attribute>
		</input><input type="hidden" name="OOSxfer">
			<xsl:attribute name="value">
				<xsl:value-of select="OOS_Tx"/>
			</xsl:attribute>
		</input><input type="hidden" name="Logby">
			<xsl:attribute name="value">
				<xsl:value-of select="Log_by"/>
			</xsl:attribute>
		</input><input type="hidden" name="Logdate">
			<xsl:attribute name="value">
				<xsl:value-of select="Log_Date"/>
			</xsl:attribute>
		</input><input type="hidden" name="Reportby">
			<xsl:attribute name="value">
				<xsl:value-of select="Reported_by"/>
			</xsl:attribute>
		</input><input type="hidden" name="Fault">
			<xsl:attribute name="value">
				<xsl:value-of select="Fault_Description"/>
			</xsl:attribute>
		</input><input type="hidden" name="Repair">
			<xsl:attribute name="value">
				<xsl:value-of select="Repair_Description"/>
			</xsl:attribute>
		</input><input type="hidden" name="Assto">
			<xsl:attribute name="value">
				<xsl:value-of select="Assigned_to"/>
			</xsl:attribute>
		</input><input type="hidden" name="Assdate">
			<xsl:attribute name="value">
				<xsl:value-of select="Assign_Date"/>
			</xsl:attribute>
		</input><input type="hidden" name="OutJN">
			<xsl:attribute name="value">
				<xsl:value-of select="Outsource_JN"/>
			</xsl:attribute>
		</input><input type="hidden" name="Return">
			<xsl:attribute name="value">
				<xsl:value-of select="Returned"/>
			</xsl:attribute>
		</input><input type="hidden" name="Junk">
			<xsl:attribute name="value">
