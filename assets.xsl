...
<xsl:choose>
	<xsl:when test="$thevalue = ''">
		<xsl:for-each select="//inventory/assitem">
			<tr>
				<td align="center" width="100"><xsl:value-of select="subcode"/></td>
				<td align="center"><xsl:value-of select="description"/></td>
				<td align="center" width="150"><xsl:value-of select="assetnum"/></td>
				<td align="center" width="150"><xsl:choose>
					<xsl:when test="dpt='1'">Base</xsl:when>
					<xsl:when test="dpt='02'">Hilton</xsl:when>
					<xsl:when test="dpt='03'">Sebel</xsl:when>
					<xsl:when test="dpt='04'">Langham</xsl:when>
					<xsl:when test="dpt='05'">INACTIVE</xsl:when>
					<xsl:when test="dpt='06'">Promenade</xsl:when>
					<xsl:when test="dpt='07'">Crown</xsl:when>
					<xsl:when test="dpt='08'">Rialto</xsl:when>
					<xsl:when test="dpt='09'">Park Hyatt</xsl:when>
					<xsl:when test="dpt='10'">Theatrette</xsl:when>
					<xsl:when test="dpt='12'">Airport</xsl:when>
					<xsl:when test="dpt='13'">Novotel</xsl:when>
					<xsl:when test="dpt='14'">Westin</xsl:when>
					<xsl:when test="dpt='15'">Geelong</xsl:when>
					<xsl:when test="dpt='18'">AV Express</xsl:when>
					<xsl:when test="dpt='19'">RACV</xsl:when>
					<xsl:when test="dpt='21'">Grand Hyatt</xsl:when>
				</xsl:choose></td>
			</tr>
		</xsl:for-each>
	</xsl:when>
	<xsl:otherwise>
	    <xsl:choose>
		<xsl:when test="$thename = 'Class'">
			<xsl:for-each select="//inventory/assitem">
				<xsl:sort select="subcode"/>
				<xsl:if test="substring(subcode,1,1) = $thevalue">
					<tr>
						<td align="center" width="100"><xsl:value-of select="subcode"/></td>
						<td align="center"><xsl:value-of select="description"/></td>
						<td align="center" width="150"><xsl:value-of select="assetnum"/></td>
		...
		<xsl:when test="$thename = 'SubC'">
			<xsl:for-each select="//inventory/assitem">
				<xsl:sort select="subcode"/>
				<xsl:if test="subcode = $thevalue">
					<tr>
						<td align="center" width="100"><xsl:value-of select="subcode"/></td>
						<td align="center"><xsl:value-of select="description"/></td>
						<td align="center" width="150"><xsl:value-of select="assetnum"/></td>
		...
		<xsl:when test="$thename = 'ItDes'">
			<xsl:for-each select="//inventory/assitem">
				<xsl:sort select="subcode"/>
				<xsl:if test="description = $thevalue">
					<tr>
						<td align="center" width="100"><xsl:value-of select="subcode"/></td>
						<td align="center"><xsl:value-of select="description"/></td>
						<td align="center" width="150"><xsl:value-of select="assetnum"/></td>
