...
<table cellpadding="0" cellspacing="0" width="100%">
	<tr>
		...
		<td align="center">
			<select onchange="updatelist('Class',this.value)">
				<option>all</option>
				...
				<option value="V">Vs</option>
			</select>
		</td>
		<td align="center">
			<select onchange="updatelist('SubC',this.value)">
				<option>all</option>
				<xsl:for-each select="//inventory/assitem">
				    <xsl:sort select="subcode"/>
					<xsl:choose><xsl:when test="not(subcode=preceding::subcode)">
					<option>
		...
		<td align="center">
			<select onchange="updatelist('ItDes',this.value)">
				<option>all</option>
				<xsl:for-each select="//inventory/assitem">
				    <xsl:sort select="description"/>
					<xsl:choose><xsl:when test="not(description=preceding::description)">
					<option>
						<xsl:attribute name="value">
		...
		<td align="center">
			<select onchange="updatelist('Dept',this.value)">
				<option>all</option>
